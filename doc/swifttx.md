...
This mechanism has been integrated into Bitcore-Node-TIMcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TIMcoin-Project/insight-api-timcoin#web-socket-api](https://github.com/TIMcoin-Project/insight-api-timcoin#web-socket-api) 
* API: [https://github.com/TIMcoin-Project/insight-api-timcoin#swifttx-transactions](https://github.com/TIMcoin-Project/insight-api-timcoin#swifttx-transactions) 
...
By default, the TIMcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TIMcoin Core daemon:
