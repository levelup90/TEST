...
In order to support loading of multiple wallets in timcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is timcoin.cpp.
...
Changes to timcoin.cpp
----------------------
timcoin.cpp is the entry point into timcoin-qt, and as such, will require some minor modifications to provide hooks for
