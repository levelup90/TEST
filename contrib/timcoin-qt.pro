...
RESOURCES += src/qt/timcoin.qrc src/qt/timcoin_locale.qrc

TRANSLATIONS += src/qt/locale/timcoin_bg.ts \
                src/qt/locale/timcoin_de.ts \
                src/qt/locale/timcoin_en.ts \
                src/qt/locale/timcoin_es.ts \
                src/qt/locale/timcoin_fi.ts \
                src/qt/locale/timcoin_fr.ts \
                src/qt/locale/timcoin_it.ts \
                src/qt/locale/timcoin_ja.ts \
                src/qt/locale/timcoin_pl.ts \
                src/qt/locale/timcoin_pt.ts \
                src/qt/locale/timcoin_ru.ts \
                src/qt/locale/timcoin_sk.ts \
                src/qt/locale/timcoin_sv.ts \
                src/qt/locale/timcoin_vi.ts \
                src/qt/locale/timcoin_zh_CN.ts \
                src/qt/locale/timcoin_zh_TW.ts
