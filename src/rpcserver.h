...
/**
 * TIMcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setztimseed(const UniValue& params, bool fHelp);
extern UniValue getztimseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztim(const UniValue& params, bool fHelp);
extern UniValue dztimstate(const UniValue& params, bool fHelp);
