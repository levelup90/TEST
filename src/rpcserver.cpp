...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "TIMcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TIMcoin features */
        {"timcoin", "masternode", &masternode, true, true, false},
        {"timcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"timcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"timcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"timcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"timcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"timcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"timcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"timcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"timcoin", "startmasternode", &startmasternode, true, true, false},
        {"timcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"timcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"timcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"timcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"timcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"timcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"timcoin", "mnbudget", &mnbudget, true, true, false},
        {"timcoin", "preparebudget", &preparebudget, true, true, false},
        {"timcoin", "submitbudget", &submitbudget, true, true, false},
        {"timcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"timcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"timcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"timcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"timcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"timcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"timcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"timcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"timcoin", "mnsync", &mnsync, true, true, false},
        {"timcoin", "spork", &spork, true, true, false},
        {"timcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getztimseed", &getztimseed, false, false, true},
        {"zerocoin", "setztimseed", &setztimseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdztim", &searchdztim, false, false, true},
        {"zerocoin", "dztimstate", &dztimstate, false, false, true}
...
{
    return "> timcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8061/\n";
}
