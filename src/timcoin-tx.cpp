...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TIMcoin Core timcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  timcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded timcoin transaction") + "\n" +
                               "  timcoin-tx [options] -create [commands]   " + _("Create hex-encoded timcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded timcoin transaction
