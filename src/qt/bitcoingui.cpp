                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TIMcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TIMcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and timcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTIM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TIMcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TIMcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TIMcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TIMcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TIMcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a TIMcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TIMcoin Core help message to get a list with possible TIMcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TIMcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TIMcoin network", "", count));
}
...
{
    QString strTitle = tr("TIMcoin Core"); // default title
