...
/* TIMcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TIMcoin"
#define QAPP_ORG_DOMAIN "timcoin.org"
#define QAPP_APP_NAME_DEFAULT "TIMcoin-Qt"
#define QAPP_APP_NAME_TESTNET "TIMcoin-Qt-testnet"
