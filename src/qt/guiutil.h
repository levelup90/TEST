...
/** Utility functions used by the TIMcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TIMcoin addresses in monospace font
...
// Parse "timcoin:" URI into recipient object, return true on successful parsing
