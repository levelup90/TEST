                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTIMPathCustom = GetArg("-ztimbackuppath", "");
    ...
    if(!strzTIMPathCustom.empty()) {
        ui->wallet_customztimbackuppath->setText(QString::fromStdString(strzTIMPathCustom));
        ui->wallet_customztimbackuppath_label->setVisible(true);
        ui->wallet_customztimbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTIMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TIMcoin RPC console.") + "<br>" +
