...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->ztimTracker->HasMintTx(hash))) {
            //zTIM stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZTIM;
...
bool IsZTIMType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZTIM:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZTIM || type == TransactionRecord::MNReward) {
