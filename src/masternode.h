...
#define MASTERNODE_MIN_CONFIRMATIONS 35
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 TIM, signature to prove
