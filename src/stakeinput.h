...
#ifndef TIMcoin_STAKEINPUT_H
#define TIMcoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZTIM() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zTIMStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked ztim, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZTIM() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZTIM() override { return false; }
};


#endif //TIMcoin_STAKEINPUT_H
