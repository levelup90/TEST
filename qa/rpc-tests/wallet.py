...
#   c) node1 mines 32 blocks, so now node 0 has 60001tim, node 1 has 4250tim, node2 has none.
#   d) node0 sends 601 tim to node2, in two transactions (301 tim, then 300 tim).
