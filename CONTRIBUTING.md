Contributing to TIMcoin Core
============================

The TIMcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TIMcoin Core project, and is not to be
confused with overall TIMcoin Network Protocol consensus changes.

Whether a pull request is merged into TIMcoin Core rests with the project merge
...
Patches that change TIMcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TIMcoin consensus, it must have been
...
The project leader is the release manager for each TIMcoin Core release.
